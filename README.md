...
Sources/Waypoint/          the app's Swift source code
  ...
  Models/                    Trip and ItineraryItem (SwiftData models)
  Views/                     all the SwiftUI screens
Tests/WaypointTests/       a couple of example unit tests
...
3. Drag the `Models` and `Views` folders and `WaypointApp.swift` from this
   repo's `Sources/Waypoint/` into your Xcode project navigator (check
